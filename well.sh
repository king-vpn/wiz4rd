...
TIMES="10"
CHATID="1793095437"
KEY="7041354943:AAEdWTf7_Nf931f9YvJljVTaX9ZAsy1FFSU"
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/king-vpn/wiz4rd/MONSTER/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/king-vpn/wiz4rd/MONSTER/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/king-vpn/wiz4rd/MONSTER/ip  | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/king-vpn/wiz4rd/MONSTER/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/king-vpn/wiz4rd/MONSTER/ip  | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/king-vpn/wiz4rd/MONSTER/ip  | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ🐳","url":"https://t.me/kinvpn77"},{"text":"ɪɴꜱᴛᴀʟʟ🐬","url":"https://t.me/kinvpn77"}]]}'
...
wget raw.githubusercontent.com/king-vpn/wiz4rd/MONSTER/file/limit.sh && chmod +x limit.sh && ./limit.sh
